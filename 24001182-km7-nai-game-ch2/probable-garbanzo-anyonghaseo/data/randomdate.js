...
// Fungsi untuk merandom tanggal dalam 1 bulan ke depan
...
// Mendapatkan tanggal saat ini dan 1 bulan ke depan
const today = new Date();
const oneMonthLater = new Date();
oneMonthLater.setMonth(today.getMonth() + 1);

// Memperbarui tanggal 'availableAt' pada setiap data mobil
cars.forEach((car) => {
  car.availableAt = randomDate(today, oneMonthLater).toISOString();
});

// Menampilkan hasil JSON yang sudah diperbarui di console
